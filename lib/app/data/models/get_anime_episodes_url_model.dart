class GetAnimeEpisodesUrlModel {
  Headers? headers;
  List<Sources>? sources;
  String? download;

  GetAnimeEpisodesUrlModel({this.headers, this.sources, this.download});

  GetAnimeEpisodesUrlModel.fromJson(Map<String, dynamic> json) {
    headers =
